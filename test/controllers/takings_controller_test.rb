...
#       post takings_url, params: { taking: { course_id: @taking.course_id, student_id: @taking.student_id } }
#     end
...
#     patch taking_url(@taking), params: { taking: { course_id: @taking.course_id, student_id: @taking.student_id } }
